...
TEST(khovansky_d_rectangles_integral_mpi, test_integral_1d_x_squared) {
  ...
  khovansky_d_rectangles_integral_mpi::RectanglesMpi rectangles(task_data_mpi);
  rectangles.integrand_function_ = [](const std::vector<double> &point) { return point[0] * point[0]; };
...
TEST(khovansky_d_rectangles_integral_mpi, test_integral_2d_xy) {
  ...
  khovansky_d_rectangles_integral_mpi::RectanglesMpi rectangles(task_data_mpi);
  rectangles.integrand_function_ = [](const std::vector<double> &point) { return point[0] * point[1]; };
  rectangles.PreProcessingImpl();
  rectangles.RunImpl();
  rectangles.PostProcessingImpl();
...
TEST(khovansky_d_rectangles_integral_mpi, test_inverted_bounds_1) {
  boost::mpi::communicator world;
  auto task_data_mpi = std::make_shared<ppc::core::TaskData>();
...
TEST(khovansky_d_rectangles_integral_mpi, test_mismatched_bounds_dimension) {
  boost::mpi::communicator world;
  auto task_data_mpi = std::make_shared<ppc::core::TaskData>();
  std::vector<double> lower_limits = {0.0, 0.0};
  std::vector<double> upper_limits = {3.0, 7.0, 5.0};
  int num_partitions = 100;
  double integral_result = 0.0;
...
TEST(khovansky_d_rectangles_integral_mpi, test_mismatched_bounds_dimension2) {
  boost::mpi::communicator world;
  auto task_data_mpi = std::make_shared<ppc::core::TaskData>();
  std::vector<double> lower_limits = {0.0, 0.0, -12.0, 2.0};
  std::vector<double> upper_limits = {3.0, 7.0, 5.0};
  int num_partitions = 100;
  double integral_result = 0.0;
...
TEST(khovansky_d_rectangles_integral_mpi, test_integral_3d_xyz) {
  ...
  khovansky_d_rectangles_integral_mpi::RectanglesMpi rectangles(task_data_mpi);
  rectangles.integrand_function_ = [](const std::vector<double> &point) { return point[0] * point[1] * point[2]; };
  rectangles.PreProcessingImpl();
  rectangles.RunImpl();
  rectangles.PostProcessingImpl();
...
TEST(khovansky_d_rectangles_integral_mpi, test_integral_4d_xyzt) {
  ...
  khovansky_d_rectangles_integral_mpi::RectanglesMpi rectangles(task_data_mpi);
  rectangles.integrand_function_ = [](const std::vector<double> &point) { return point[0] * point[1] * point[2] * point[3]; };
  rectangles.PreProcessingImpl();
  rectangles.RunImpl();
  rectangles.PostProcessingImpl();
